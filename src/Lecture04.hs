...
adopt (AnimalWithType age ('D':name) Cat) = Left "Can't adopt cat"
adopt (AnimalWithType age name Cat) = if age < 5 then Right (AdoptedAnimal (AnimalWithType age name Cat)) else Left "Can't adopt cat"
adopt (AnimalWithType age name Dog) = if age > 1 then Right (AdoptedAnimal (AnimalWithType age name Dog)) else Left "Can't adopt dog"
adopt (AnimalWithType age name Duck) = if name == "Daisy" then Right (AdoptedAnimal (AnimalWithType age name Duck)) else Left "Quack"
...
getLeft (Node value _ _) = Just value
getLeft _ = Nothing
